...
public class UserTest2 {
    ...
    public void testGetUser(){
        Response getresponse = UserEndPoints2.getUser(this.userPayload.getUsername());
    ...
    public void testUpdateUser(){
        ...
        Response updateResponse = UserEndPoints2.updateUser(this.userPayload.getUsername(), userPayload);
    ...
    public void testDeleteUser(){
        Response deleteResponse = UserEndPoints2.deleteUser(this.userPayload.getUsername());
